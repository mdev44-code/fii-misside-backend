...
def upgrade() -> None:
    ...
    op.create_table('association_settings',
    ...
    op.create_table('treasury_balance',
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('member_id', 'contribution_month', 'contribution_year', name='uq_contribution_member_month_year')
    )
